...
public class CmmsEquipment extends OModel {
    ...
    //////////////////////////////////////////////////////////
    OColumn pp_controller_number = new OColumn("pp_controller_number", OVarchar.class);
    OColumn batch_number = new OColumn("batch_number", OVarchar.class);
    OColumn pp_serial_number = new OColumn("pp_serial_number", OVarchar.class);
    OColumn uk_supp_agr = new OColumn("uk_supp_agr", OBoolean.class);
    OColumn remote_serial_number = new OColumn("remote_serial_number", OVarchar.class);
    OColumn lanyard_bat_upg = new OColumn("lanyard_bat_upg", OBoolean.class);
    OColumn lift_bat_serial1 = new OColumn("lift_bat_serial1", OVarchar.class);
    OColumn lift_bat_serial2 = new OColumn("lift_bat_serial2", OVarchar.class);
    OColumn pside_cont_software = new OColumn("pside_cont_software", OVarchar.class);
    OColumn rfid_soft = new OColumn("rfid_soft", OVarchar.class);
    OColumn remote_pull_upgraded = new OColumn("remote_pull_upgraded",OBoolean.class);
    OColumn pp_remote_software = new OColumn("pp_remote_software", OVarchar.class);
    OColumn pp_remote_charger_type = new OColumn("pp_remote_charger_type", OVarchar.class);
    OColumn anchor_short = new OColumn("short", OBoolean.class);
    OColumn anchor_medium = new OColumn("medium", OBoolean.class);
    OColumn other_anchor = new OColumn("other_anchor", OBoolean.class);
  ...
  //  OColumn pside_con_bat = new OColumn("pside_con_bat", OSelection.class).addSelection("1","1P Plug").addSelection("2", "1P Stab in").addSelection("3","Pouch");
    ...
    OColumn door_lock_sensor = new OColumn("door_lock_sensor ", OSelection.class).addSelection("1","Omrom (Braket)").addSelection("2", "Omrom (Plate)").addSelection("3","Orange cap").addSelection("4","Reed");
    OColumn motor_con = new OColumn("motor_con", OSelection.class).addSelection("1","V3").addSelection("2", "V2 Plug").addSelection("3","V2.0 Stab in").addSelection("4","V1.0 Stab in");
    OColumn pp_remote_control = new OColumn("pp_remote_control", OSelection.class).addSelection("1", "Version 7(With graphic)").addSelection("2", "Version 6(Without graphic)");
